...
By mobileEmail=By.xpath("//input[@id='u_0_r']");
By remobileEmail=By.xpath("//input[@id='u_0_u']");
...
{
	return driver.findElement(mobileEmail);
}

public WebElement getRemobileemail()
{
	return driver.findElement(remobileEmail);
}
